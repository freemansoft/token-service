...
namespace TokenService.RTepository.Repository
{
    ...
    /// </summary>
    public class TokenDynamoDbRepository : IRepository<TokenEntity>
    {

        /// <summary>
        /// injected
        /// </summary>
        private readonly ILogger<TokenDynamoDbRepository> _logger;
        ...
        public TokenDynamoDbRepository(ILogger<TokenDynamoDbRepository> logger)
        {
            _logger = logger;
        }
